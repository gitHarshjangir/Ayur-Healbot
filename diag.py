...
w2 = Label(root, justify=CENTER, text="Ayur Healbot ")
w2.config(font=("ariel", 20 ))
w2.grid(row=1, column=0, columnspan=2, pady=20)

NameLb1 = Label(root, text="")
NameLb1.config(font=("Elephant", 20))
NameLb1.grid(row=7, column=2, pady=10,  sticky=W)

S1Lb = Label(root, text="Symptom 1")
S1Lb.config(font=("Elephant", 15), bg='orange')
S1Lb.grid(row=2, column=2, pady=10, sticky=W)

S2Lb = Label(root, text="Symptom 2")
S2Lb.config(font=("Elephant", 15), bg='orange')
S2Lb.grid(row=3, column=2, pady=10, sticky=W)

S3Lb = Label(root, text="Symptom 3")
S3Lb.config(font=("Elephant", 15), bg='orange')
S3Lb.grid(row=4, column=2, pady=10, sticky=W)

S4Lb = Label(root, text="Symptom 4")
S4Lb.config(font=("Elephant", 15), bg='orange')
S4Lb.grid(row=5, column=2, pady=10, sticky=W)

S5Lb = Label(root, text="Symptom 5")
S5Lb.config(font=("Elephant", 15), bg='orange')
S5Lb.grid(row=6, column=2, pady=10, sticky=W)


lr = Button(root, text="Predict",height=2, width=10, command=message)
lr.config(font=("Elephant", 15))
lr.grid(row= 7, column=2,pady=0, sticky=W)
...
bot_button.grid(row=8, column=2, pady=10)
...
NameLb.grid(row=7, column=5, pady=0,  sticky=W)
set_green_background(NameLb)
...
t3 = Text(root, height=1, width=16)
t3.config(font=("Elephant", 20))
t3.grid(row=7, column=5, pady=0)
...
reset_button = Button(root, text="Reset", height=2, width=10, command=reset)
reset_button.config(font=("Elephant", 15))
reset_button.grid(row=8, column=5)
set_green_background(reset_button)
